...
If you meet the eligibility criteria determined by ExinOne, you may submit a Request for Quote ("RFQ") providing the details listed in this section. After submitting the RFQ, you will receive a Quoted Subscription detailing the terms of the Dual Investment subscription. These terms may be refreshed periodically, and you are responsible for ensuring they meet your expectations. If you do not act within the validity period, ExinOne does not guarantee that you can proceed with the same or similar terms.
...
G. Definitions
	...
	•	Dual Investment Services: The services described in Section B of these Terms.
	•	Dual Investment Terms: These Terms.
	•	Future Transaction: A new Dual Investment transaction following the current one.
	•	Quoted Subscription: A quoted offer returned by ExinOne in response to an RFQ for subscribing to a Dual Investment.
	•	Reached:
	...
	•	RFQ: Request for Quote — a subscription quote request submitted by the user to ExinOne.
