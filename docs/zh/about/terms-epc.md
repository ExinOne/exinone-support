...
3.1 EPC 不构成任何形式的金融产品或投资工具，ExinOne 不对 EPC 的价值作出任何承诺或保证。

3.2 因不可抗力、系统维护、第三方服务故障等原因导致 EPC 服务中断或异常的，ExinOne 不承担相应责任，但将采取合理措施尽快恢复服务。

### 四．法律适用与争议解决

4.1 本协议受塞舌尔共和国法律管辖。任何争议应首先通过友好协商解决；协商不成的，提交塞舌尔共和国有管辖权的法院解决。

4.2 本协议语言为英文，为方便用户理解，本协议可能会被翻译成不同语言。如不同语言版本之间内容有不一致的，以英文版本为准。
